...
\begin{tikzpicture}
	...
	\IfStandalone{}{
        ...
        \onslide*<2>{\pic at (cl1-root) {vebset={2 color green}};}
        \onslide*<4>{\pic at (cl1-0-root) {vebbase={color green}};}
        \onslide*<6>{\pic at (cl1-sum-root) {vebbase={color green}};}
        \onslide*<8>{\pic at (cl1-0-root) {vebbase={color green}};}
	}
	...
	\IfStandalone{}{
	    \onslide*<3>{\node[highlight] at (cl1-min) {$0$};}
	    \onslide*<4->{\node[plane] at (cl1-min) {$0$};}
	    \onslide*<5>{\node[highlight] at (cl1-0-element0) {$\NIL$};}
	    \onslide*<7>{\node[highlight] at (cl1-sum-element0) {$0$};}
	    \onslide*<7>{\node[highlight] at (cl1-sum-element1) {$0$};}
	    \onslide*<8->{\node[plane] at (cl1-sum-element0) {$0$};}
	    \onslide*<8->{\node[plane] at (cl1-sum-element1) {$0$};}
	    \onslide*<9>{\node[highlight] at (cl1-0-element0) {$1$};}
	    \onslide*<9>{\node[highlight] at (cl1-0-element1) {$1$};}
	}
