...
\begin{tikzpicture}
	...
	\IfStandalone{}{
        ...
        \onslide*<5>{\pic at (summary-root) {vebset={2 color green}};}
        \onslide*<8>{\pic at (sum-sum-root) {vebbase={color green}};}
        \onslide*<10>{\pic at (sum-cl1-root) {vebbase={color green}};}
        \onslide*<12>{\pic at (cl2-root) {vebset={2 color green}};}
	}
