...
\begin{tikzpicture}
	...
	\IfStandalone{}{
        ...
        \onslide*<3>{\pic at (cl1-root) {vebset={2 color green}};}
        \onslide*<5>{\pic at (cl1-0-root) {vebbase={color green}};}
        \onslide*<7>{\pic at (cl1-sum-root) {vebbase={color green}};}
	}
	...
	\node[plane] at (cl1-min) {$0$}; %4-7(0-3)
	...
	\node[plane] at (cl1-sum-element0) {$0$}; %4-5
	\node[plane] at (cl1-sum-element1) {$0$}; %6-7
	\node[plane] at (cl1-0-element0) {$1$}; %4
	...
	\IfStandalone{}{
	    ...
	    \onslide*<4>{\node[highlight] at (cl1-min) {$1$};}
	    \onslide*<5->{\node[plane] at (cl1-min) {$1$};}
	    \onslide*<6>{\node[highlight] at (cl1-0-element0) {$\NIL$};}
	    \onslide*<6>{\node[highlight] at (cl1-0-element1) {$\NIL$};}
	    \onslide*<7->{\node[plane] at (cl1-0-element0) {$\NIL$};}
	    \onslide*<7->{\node[plane] at (cl1-0-element1) {$\NIL$};}
	    \onslide*<8>{\node[highlight] at (cl1-sum-element0) {$\NIL$};}
	    \onslide*<8>{\node[highlight] at (cl1-sum-element1) {$\NIL$};}
	}
