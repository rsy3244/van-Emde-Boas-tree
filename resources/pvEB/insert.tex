...
\begin{tikzpicture}
    ...
    \IfStandalone{
        ...
        \onslide*<2>{\pic at (summary-root) {pvebset={2 color green}};}
        \onslide*<3>{\pic at (sum-sum-root) {pvebbase={color green}};}
        \onslide*<5>{\pic at (sum-cl1-root) {pvebbase={color green}};}
        \onslide*<7>{\pic at (cl3-root) {pvebset={2 color green}};}
        \onslide*<8>{\pic at (cl3-sum-root) {pvebbase={color green}};}
        \onslide*<10>{\pic at (cl3-0-root) {pvebbase={color green}};}
    }
	...
	\IfStandalone{}{
	    ...
	    \onslide*<6>{\node[highlight] at (sum-cl1-element1) {$1$};}
	    \onslide*<7->{\node[plane] at (sum-cl1-element1) {$1$};}
	    \onslide*<9>{\node[highlight] at (cl3-sum-element0) {$1$};}
	    \onslide*<10->{\node[plane] at (cl3-sum-element0) {$1$};}
	    \onslide*<11>{\node[highlight] at (cl3-0-element0) {$1$};}
	}
