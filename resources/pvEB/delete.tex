...
\begin{tikzpicture}
    ...
    \IfStandalone{
        ...
        \onslide*<2>{\pic at (cl3-root) {pvebset={2 color green}};}
        \onslide*<3>{\pic at (cl3-0-root) {pvebbase={color green}};}
        \onslide*<6>{\pic at (cl3-sum-root) {pvebbase={color green}};}
        \onslide*<8>{\pic at (summary-root) {pvebset={2 color green}};}
        \onslide*<9>{\pic at (sum-cl1-root) {pvebbase={color green}};}
    }
	...
	\node[plane] at (sum-cl1-element1) {$1$}; %12-15
	...
	\node[plane] at (cl3-sum-element0) {$1$}; %12-13
	\node[plane] at (cl3-sum-element1) {$0$}; %14-15
	\node[plane] at (cl3-0-element0) {$1$}; %12
	\node[plane] at (cl3-0-element1) {$0$}; %13
	\node[plane] at (cl3-1-element0) {$0$}; %14
	\node[plane] at (cl3-1-element1) {$0$}; %15
	
	\IfStandalone{}{
	    \onslide*<4>{\node[highlight] at (cl3-0-element0) {$0$};}
	    \onslide*<5->{\node[plane] at (cl3-0-element0) {$0$};}
	    \onslide*<7>{\node[highlight] at (cl3-sum-element0) {$0$};}
	    \onslide*<8->{\node[plane] at (cl3-sum-element0) {$0$};}
	    \onslide*<10>{\node[highlight] at (sum-cl1-element1) {$0$};}
	}
	...
	\IfStandalone{}{
	    \onslide*<5>{\draw[redline] (cl3-0-element1.south west) rectangle (cl3-0-element0.north east);}
	}
