...
\begin{tikzpicture}
    ...
    \IfStandalone{
        ...
        \onslide*<5>{\pic at (sum-cl0-root) {pvebbase={color green}};}   	
        \onslide*<7>{\pic at (cl0-root) {pvebset={2 color green}};}   	
        \onslide*<8>{\pic at (cl0-sum-root) {pvebbase={color green}};}
    }
	...
	\IfStandalone{}{
	    \onslide*<4>{\node[highlight] at (sum-sum-element0) {$1$};}
	    \onslide*<6>{\node[highlight] at (sum-cl0-element0) {$1$};}
	    \onslide*<9>{\node[highlight] at (cl0-1-element0) {$1$};}
	}
